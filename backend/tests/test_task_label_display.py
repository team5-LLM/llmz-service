...
class TaskLabelDisplayUtilTests(unittest.TestCase):
    ...
    def test_display_prefers_cluster_label(self):
        self.assertEqual(
            task_label_display("마케팅팀_cluster_7", cluster_label="캠페인 성과 리포트"),
            "캠페인 성과 리포트",
        )
...
class RecommendationDisplayTests(unittest.TestCase):
    ...
    def test_enrich_uses_cluster_label_for_cluster_cards(self):
        rec = enrich_recommendation_xai(
            {
                "department": "마케팅팀",
                "task_label": "마케팅팀_cluster_7",
        ...
        self.assertEqual(rec["task_label_display"], "캠페인 성과 리포트")
