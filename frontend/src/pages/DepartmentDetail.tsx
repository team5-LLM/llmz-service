...
const dummyRecommendations: Recommendation[] = [
  { department: '마케팅팀', task_label: '보고서 작성형', service_name: 'GPT 보고서 자동화', expected_effect: '작성 시간 60% 절감', difficulty: '낮음', required_resources: 'API 키', opportunity_score: 88, risk_score: 24, risk_level: 'Low', decision: '도입 권장', decision_level: 'green', decision_message: '즉시 도입 가능', required_action: 'API 연동', reason: '반복 작업 비율 높음' },
  { department: '마케팅팀', task_label: '코드 생성형', service_name: 'Copilot 도입', expected_effect: '개발 생산성 향상', difficulty: '중간', required_resources: '라이선스', opportunity_score: 65, risk_score: 30, risk_level: 'Low', decision: '검토 필요', decision_level: 'yellow', decision_message: '팀 교육 필요', required_action: '교육 계획', reason: '사용 비율 낮음' },
  { department: '개발팀', task_label: '코드 생성형', service_name: 'Copilot 도입', expected_effect: '개발 속도 40% 향상', difficulty: '낮음', required_resources: '라이선스', opportunity_score: 92, risk_score: 18, risk_level: 'Low', decision: '도입 권장', decision_level: 'green', decision_message: '즉시 도입 가능', required_action: '라이선스 구매', reason: '코드 생성 비율 높음' },
  { department: '개발팀', task_label: '문서 요약형', service_name: 'Claude 요약 봇', expected_effect: '문서 처리 시간 절감', difficulty: '낮음', required_resources: 'API 키', opportunity_score: 75, risk_score: 20, risk_level: 'Low', decision: '도입 권장', decision_level: 'green', decision_message: '즉시 도입 가능', required_action: 'API 연동', reason: '문서 처리 빈번' },
  { department: '고객지원팀', task_label: '고객 응대형', service_name: '챗봇 자동화', expected_effect: '응대 시간 50% 절감', difficulty: '높음', required_resources: '개발 인력', opportunity_score: 70, risk_score: 45, risk_level: 'Medium', decision: '조건부 도입', decision_level: 'yellow', decision_message: '보안 검토 필요', required_action: '보안 감사', reason: '고객 데이터 처리' },
  { department: '재무/기획팀', task_label: '고객 응대형', service_name: '재무 분석 AI', expected_effect: '분석 정확도 향상', difficulty: '높음', required_resources: '전문 인력', opportunity_score: 60, risk_score: 72, risk_level: 'High', decision: '보류', decision_level: 'red', decision_message: '위험도 재검토', required_action: '위험 분석', reason: '민감 데이터 포함' },
  { department: '영업팀', task_label: '단순 검색/질문형', service_name: '영업 지원 봇', expected_effect: '정보 검색 시간 절감', difficulty: '낮음', required_resources: 'API 키', opportunity_score: 80, risk_score: 28, risk_level: 'Low', decision: '도입 권장', decision_level: 'green', decision_message: '즉시 도입 가능', required_action: 'API 연동', reason: '단순 반복 검색 많음' },
]
